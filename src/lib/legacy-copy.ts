const copyReplacements: Array<[RegExp, string]> = [
  [/\b6529 Hook Builder\b/g, "6529 Hook"],
  [/\b6529 Hook Project\b/g, "6529 Hook"],
  ...
  [/\bbuilder wave plus GitHub repo\b/gi, "6529 room and code repo"],
  [/\b6529 discussion and GitHub repo\b/gi, "6529 room and code repo"],
