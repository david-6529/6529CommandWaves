...
1. Proposal has a recorded project chat decision link.
...
- Generates a copyable manual Codex work packet for PR commands with a recorded project chat decision link.
