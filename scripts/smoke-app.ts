...
async function main() {
  ...
  for (const label of [
    ...
    "Pilot: 6529 AMM hook",
    "A shared workspace for people and agents to turn discussion into reviewed pull requests.",
    "Build one hook in public",
    "Builders discuss work here.",
    "Project chat",
    "Code repo",
    "Who can contribute",
    ...
    "Rules of the build",
    "Important or risky changes need a visible project decision.",
