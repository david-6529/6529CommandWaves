...
- Contribution reporting is a daemon-generated visible-activity analysis with partial confidence. It uses visible app
  activity, project chat posts pulled into the app, recorded PR links, and repo-bound review proof. Builder profiles show activity, voting summaries, and report points as context only. Full scoring
